...
- [![kubernetesloong64/maven-loong64:3.9.16-8-debian-slim](https://img.shields.io/docker/v/kubernetesloong64/maven-loong64/3.9.16-8-debian-slim?arch=loong64&logo=docker&label=kubernetesloong64%2Fmaven-loong64)](https://hub.docker.com/r/kubernetesloong64/maven-loong64/tags)
- [![kubernetesloong64/maven-loong64:3.9.16-11-debian-slim](https://img.shields.io/docker/v/kubernetesloong64/maven-loong64/3.9.16-11-debian-slim?arch=loong64&logo=docker&label=kubernetesloong64%2Fmaven-loong64)](https://hub.docker.com/r/kubernetesloong64/maven-loong64/tags)
- [![kubernetesloong64/maven-loong64:3.9.16-17-debian-slim](https://img.shields.io/docker/v/kubernetesloong64/maven-loong64/3.9.16-17-debian-slim?arch=loong64&logo=docker&label=kubernetesloong64%2Fmaven-loong64)](https://hub.docker.com/r/kubernetesloong64/maven-loong64/tags)
- [![kubernetesloong64/maven-loong64:3.9.16-21-debian-slim](https://img.shields.io/docker/v/kubernetesloong64/maven-loong64/3.9.16-21-debian-slim?arch=loong64&logo=docker&label=kubernetesloong64%2Fmaven-loong64)](https://hub.docker.com/r/kubernetesloong64/maven-loong64/tags)
...
A Chinese mirror is also available at `registry.cn-qingdao.aliyuncs.com/kubernetesloong64/maven-loong64`. Pull from the mirror by replacing the registry:
...
# JDK 8 (debian-slim)
docker pull kubernetesloong64/maven-loong64:3.9.16-8-debian-slim

# JDK 11 (debian-slim)
docker pull kubernetesloong64/maven-loong64:3.9.16-11-debian-slim

# JDK 17 (debian-slim)
docker pull kubernetesloong64/maven-loong64:3.9.16-17-debian-slim

# JDK 21 (debian-slim)
docker pull kubernetesloong64/maven-loong64:3.9.16-21-debian-slim

# JDK 25 (debian-slim)
docker pull kubernetesloong64/maven-loong64:3.9.16-25-debian-slim
